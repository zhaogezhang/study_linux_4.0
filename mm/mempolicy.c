...
/*
 * run-time system-wide default policy => local node allocation
 */
 ...
 * page allocation
 */
// 根据 gfp 和 内存分配策略返回用于分配内存的 node mask
...
// 根据 gfp 和 内存分配策略返回用于内存分配的 zonelist
...
struct page *alloc_pages_current(gfp_t gfp, unsigned order)
{
	...
	// 如果没在中断上下文中，并且没有设置 __GFP_THISNODE 标志
	// 则重新获取当前进程的内存分配策略
