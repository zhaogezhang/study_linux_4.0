...
// 因为指定的页已经从伙伴系统中被申请出来，所以清除其标志，表示这个页不再在伙伴系统中
...
// 获取指定 page 所在的 zone 类型（这个 page 在那个 zone 中）
...
/*********************************************************************************************************
** 函数名称: get_mm_counter
** 功能描述: 获取指定进程的内存地址空间中指定类型的内存占用的页数
** 输	 入: mm - 指定进程的内存地址空间指针
**         : member - 指定的内存类型
** 输	 出: 
** 全局变量: 
** 调用模块: 
...
/*********************************************************************************************************
** 函数名称: add_mm_counter
** 功能描述: 把指定进程的内存地址空间中指定类型的内存占用页数统计值增加指定的增量
** 输	 入: mm - 指定进程的内存地址空间指针
**         : member - 指定的内存类型
**         : value - 指定的增量值
** 输	 出: 
...
/*********************************************************************************************************
** 函数名称: inc_mm_counter
** 功能描述: 递增指定进程的内存地址空间中指定类型的内存占用的页数统计值
** 输	 入: mm - 指定进程的内存地址空间指针
**         : member - 指定的内存类型
** 输	 出: 
** 全局变量: 
...
/*********************************************************************************************************
** 函数名称: inc_mm_counter
** 功能描述: 递减指定进程的内存地址空间中指定类型的内存占用的页数统计值
** 输	 入: mm - 指定进程的内存地址空间指针
**         : member - 指定的内存类型
** 输	 出: 
** 全局变量: 
...
/*********************************************************************************************************
** 函数名称: get_mm_rss
** 功能描述: 获取指定的进程内存地址空间中实际占用的物理内存的页数，即不包含 swap 部分的物理内存
** 输	 入: mm - 指定进程的内存地址空间指针
**         : member - 指定的内存类型
** 输	 出: unsigned long - 占用的物理内存页数
** 全局变量: 
** 调用模块: 
*********************************************************************************************************/
