 ...
 */
/* 用来记录处于每种状态下的 node mask，即每种状态下都有那些 cpu */
extern nodemask_t node_states[NR_NODE_STATES];

#if MAX_NUMNODES > 1
/*********************************************************************************************************
** 函数名称: node_state
** 功能描述: 判断当前系统内指定状态下指定的 node id 是否存在
...
/*********************************************************************************************************
** 函数名称: node_set_state
** 功能描述: 设置当前系统内指定状态下指定的 node id 标志位
** 输	 入: node - 指定的 node id
**         : state - 指定的 node 状态
** 输	 出: 
** 全局变量: 
...
/*********************************************************************************************************
** 函数名称: node_set_state
** 功能描述: 清除当前系统内指定状态下指定的 node id 标志位
** 输	 入: node - 指定的 node id
**         : state - 指定的 node 状态
** 输	 出: 
** 全局变量: 
...
/*********************************************************************************************************
** 函数名称: num_node_state
** 功能描述: 获取当前系统内处于指定状态下的 node 节点数
** 输	 入: state - 指定的 node 状态
** 输	 出: int - 存在的节点数
** 全局变量: 
** 调用模块: 
*********************************************************************************************************/
...
/*********************************************************************************************************
** 函数名称: for_each_node_mask
** 功能描述: 遍历当前系统内指定的 node state 状态下的每一个 node 节点
** 输	 入: __state - 指定的 node state 状态
** 输	 出: node - 遍历过程中可操的 node id 临时变量
** 全局变量: 
** 调用模块: 
*********************************************************************************************************/
...
/* 获取当前系统内处于 N_ONLINE 状态下的第一个 node 的 node id 值 */
#define first_online_node	first_node(node_states[N_ONLINE])

/* 获取当前系统内处于 N_MEMORY 状态下的第一个 node 的 node id 值 */
#define first_memory_node	first_node(node_states[N_MEMORY])

/*********************************************************************************************************
** 函数名称: next_online_node
** 功能描述: 获取当前系统内处于 N_ONLINE 状态下和指定的 node id 相邻且最接近的下一个 node 节点 id 值
** 输	 入: nid - 指定的 node id 
** 输	 出: int - 下一个 node 节点 id 值
** 全局变量: 
** 调用模块: 
*********************************************************************************************************/
...
/*********************************************************************************************************
** 函数名称: next_online_node
** 功能描述: 获取当前系统内处于 N_MEMORY 状态下和指定的 node id 相邻且最接近的下一个 node 节点 id 值
** 输	 入: nid - 指定的 node id 
** 输	 出: int - 下一个 node 节点 id 值
** 全局变量: 
** 调用模块: 
...
/* 记录当前系统内处于 N_ONLINE 状态下的 node 节点数 */
extern int nr_online_nodes;

/*********************************************************************************************************
** 函数名称: node_set_online
** 功能描述: 设置当前系统内指定的 node id 在 N_ONLINE 状态下的标志位并更新相关统计变量值
...
/*********************************************************************************************************
** 函数名称: node_set_online
** 功能描述: 清除当前系统内指定的 node id 在 N_ONLINE 状态下的标志位并更新相关统计变量值
** 输	 入: nid - 指定的 node id 值
** 输	 出: 
** 全局变量: 
** 调用模块: 
...
/* 获取当前系统内处于 N_ONLINE 状态的 nodemask_t 掩码值 */
#define node_online_map 	node_states[N_ONLINE]

/* 获取当前系统内处于 N_POSSIBLE 状态的 nodemask_t 掩码值 */
#define node_possible_map 	node_states[N_POSSIBLE]

/* 获取当前系统内处于 N_ONLINE 状态下的 node 节点数 */
#define num_online_nodes()	num_node_state(N_ONLINE)

/* 获取当前系统内处于 N_POSSIBLE 状态下的 node 节点数 */
#define num_possible_nodes()	num_node_state(N_POSSIBLE)

/*********************************************************************************************************
** 函数名称: node_state
** 功能描述: 判断当前系统内 N_ONLINE 状态下指定的 node id 是否存在
** 输	 入: node - 指定的 node id
** 输	 出: 1 - 存在
**         : 0 - 不存在
** 全局变量: 
...
/*********************************************************************************************************
** 函数名称: node_state
** 功能描述: 判断当前系统内 N_POSSIBLE 状态下指定的 node id 是否存在
** 输	 入: node - 指定的 node id
** 输	 出: 1 - 存在
**         : 0 - 不存在
** 全局变量: 
...
/*********************************************************************************************************
** 函数名称: for_each_node
** 功能描述: 遍历当前系统内处于 N_POSSIBLE 状态下的每一个 node 节点
** 输	 入: 
** 输	 出: node - 遍历过程中可操的 node id 临时变量
** 全局变量: 
** 调用模块: 
...
/*********************************************************************************************************
** 函数名称: for_each_node_mask
** 功能描述: 遍历当前系统内处于 N_ONLINE 状态下的每一个 node 节点
** 输	 入: 
** 输	 出: node - 遍历过程中可操的 node id 临时变量
** 全局变量: 
** 调用模块: 
